    ...
    <>
      ...
      <div className="p-3 border-t border-white/6">
        <button
          ...
          className="flex items-center gap-3 w-full px-3 py-2.5 rounded-md text-[13px]
  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden fixed top-4 left-4 z-50 p-2 bg-slate-900 text-white
      ...
      {/* Sidebar - desktop */}
      <aside
        className="hidden lg:flex flex-col h-full w-[260px] bg-linear-to-b from-slate-900
      ...
      {/* Sidebar - mobile */}
      <aside
        className={`lg:hidden fixed inset-y-0 left-0 w-72 bg-linear-to-b from-slate-900
                    via-slate-900 to-slate-950 text-white z-50 flex flex-col transform
